...
import * as Styled from '@/components/search/searchResult/RecommandResult/RecommandResult.styled';
import SearchIcon from '@/components/search/UI/SearchIcon';
import KeywordItem from '@/components/search/KeywordItem/KeywordItem';

const RecommandResult = ({ searchKeyword }) => {
...
export default RecommandResult;
